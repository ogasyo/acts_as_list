    ...
    module List #:nodoc:
      ...
      module InstanceMethods
        ...
        def higher_item
          ...
          acts_as_list_class.find(:first, :select => "#{acts_as_list_class.table_name}.#{self.class.primary_key}, #{acts_as_list_class.table_name}.#{position_column}", :conditions =>
        ...
        private
          ...
          def bottom_item(except = nil)
            ...
            acts_as_list_class.find(:first, :select => "#{acts_as_list_class.table_name}.#{self.class.primary_key}, #{acts_as_list_class.table_name}.#{position_column}", :conditions => conditions, :order => "#{acts_as_list_class.table_name}.#{position_column} DESC")
          end
